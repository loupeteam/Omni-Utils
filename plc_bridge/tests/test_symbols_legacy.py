"""
The Beckhoff bridge's parser tests, pointed at the shared nest_symbol: it has to
behave exactly like the per-vendor parsers it replaces.
Test a wide variety of inputs for parsing PLC representations of data into a dictionary
"""

import unittest

from plc_bridge import nest_symbol
...
class TestParseNameSingleVar(unittest.TestCase):
    ...
    def test_start_empty(self):
        ...
        actual_output = nest_symbol(starting_dict, input_name, value)
...
class TestParseNameMultipart(unittest.TestCase):
    ...
    def test_top_struct(self):
        ...
        actual_output = nest_symbol({}, input_name, value)
    ...
    def test_array_index_member_first(self):
        ...
        value = 30
        actual_output = nest_symbol({}, "myArray[0].myVar", value)
        correct_output =  {
                        "myArray": 
                        [
                            {"myVar": value}
    ...
    def test_array_index_member_nth(self):
        ...
        value = 30
        actual_output = nest_symbol({}, "myArray[2].myVar", value)
        correct_output =  {
                        "myArray": 
                        [   None,
                            None,
    ...
    def test_array_index_member_nth_existing_replace(self):
        ...
        value = 30
        actual_output = nest_symbol(starting_dict, "myArray[2].myVar", value)
        correct_output =  {
                            "myVar" : 1,
                                "myArray": 
                                [   1,
    ...
    def test_structure_array_index_member(self):
        ...
        value = 30
        actual_output = nest_symbol({}, "myStruct.myArray[0].myVar", value)
        correct_output =  {
                        "myStruct": 
                        {
                            "myArray": 
    ...
    def test_deep_array_inside_struct(self):
        ...
        # Global
        for value in self.test_different_data_types:
            actual_output = nest_symbol({}, "myStruct.myStruct.myStruct.myArray[0]", value)
        ...
        for value in self.test_different_data_types:
            actual_output = nest_symbol({}, "Program.myStruct.myStruct.myArray[0]", value)
...
class TestParseNameComplex(unittest.TestCase):
    ...
    def test_deep_mix_of_nesting(self):
        value = 30
        actual_output = nest_symbol({}, "Program.myStruct.myArray[1].myStruct.arr[3].myVar", value)
